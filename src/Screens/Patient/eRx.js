...
export default class eRX extends Component {
        ...
        return (
            <View style={{ flex: 1 }}>
                <View style={{ width: "100%", height: 70, alignItems: "center", justifyContent: "flex-start", flexDirection: "row", padding: 20, backgroundColor: "#147562" }}>
                    ...
                    <Text style={{ fontSize: 24, color: "white", marginLeft: 30 }}>eRx</Text>
                </View>

                <View style={{ padding: 15, width: Dimensions.get("screen").width }}>
                    <View style={{ flexDirection: "row", flexWrap : "wrap" }}>
                        {this.state.eRx.length ? this.state.eRx.map((items, index) => {
                        ...
                        }) : <Text style={{ fontSize: 14 }}>Your eRx Appear Here</Text>}
                    </View>
                </View>
            </View>
        )
